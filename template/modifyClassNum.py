...
from ShufflenetV2 import shufflenet_v2 as shufflenet
import os
...
def model_fn(features, labels, mode, params):
    ...
    if INIT_FLAG:
        ...
        init_fn = tf.contrib.framework.assign_from_checkpoint_fn(tf.train.latest_checkpoint('models/tiny_imagenet'), varialbes_to_use, ignore_missing_vars=True)
